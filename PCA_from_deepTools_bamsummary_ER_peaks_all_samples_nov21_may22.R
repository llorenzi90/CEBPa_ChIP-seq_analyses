...
##
##
## Purpose of script: check sample clustering based on ER peaks counts
##
...
setwd("~/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/CEBPa/ChIP-seq/analyses/sample_correlation/ER_peaks_all_samples_coverage_deepTools/")

da=read.table("ER_peaks_readCounts.allbams.tab")
...
#I will scale the counts by the libsize calculated with all genome bins
