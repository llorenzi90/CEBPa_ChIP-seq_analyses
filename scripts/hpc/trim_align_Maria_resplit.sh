...
#example fastq_path:
#November 2021 ChIP-seq files Maria re-split: /scratch/llorenzi/Maria_CEBPa_ChIP-seq_samples/27NOV_re_split/INP_p42_ER
...
#example run:
#find /scratch/llorenzi/Maria_CEBPa_ChIP-seq_samples/27NOV_re_split/ -maxdepth 1 -mindepth 1 -type d| while read s; do bn=$(basename $s);echo $bn;sbatch -J $bn.TrimandAlignment trim_align_Maria_resplit.sh $s;done
